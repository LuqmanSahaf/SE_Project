					...
					<h5 id="step4">Step 4: Additional Information</h5>
						<div id="content4" class="step-content">
							...
							<select id="seats" class = "select-seats">
								...
								<option id="seats3" value="3">3</option>
								<option id="seats4" value="4">4</option>
								<option id="seats5" value="5">5</option>
								<option id="seats6" value="6">6</option>
								<option id="seats7" value="7">7</option>
								<option id="seats8" value="8">8</option>
								<option id="seats9" value="9">9</option>
								<option id="seats10" value="10">10</option>
							</select>
							</span>
						</div>
